from modelviews.statisticstab.dataselectiontabmv import DataSelectionTabMV
from modelviews.statisticstab.dataexploretabmv import DataExploreTabMV
from modelviews.statisticstab.regressionmv import RegressionMV
