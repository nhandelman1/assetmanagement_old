    ...
    def input_bill_data(self, re_dict, sp_dict):
        ...
        while True:
            ...
            if len(tc_split) != 2 or len(tc_split[1]) != 2:
                print("Must have 2 decimal places. Try again.")
                continue
        ...
        bill = SimpleServiceBillData(re_dict[re_id], sp_dict[sp_id], start_date, end_date, Decimal(total_cost),
                                     notes=notes)
